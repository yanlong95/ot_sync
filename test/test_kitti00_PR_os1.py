...
def cal_pr_curve(prediction_file_name, ground_truth_file_name):
    ...
    print('Load descriptor distances predictions with pairs of ', len(des_dists))
...
def plotPRC(precisions, recalls, print_2file=True):
    ...
    if print_2file:
        save_name = '/home/vectr/Documents/Dataset/test/test_results_botanical_garden/PR.png'
...
def test_with_PR(ground_truth_file_name):
    ...
    prediction_file_name = "/home/vectr/Documents/Dataset/test/test_results_botanical_garden/predicted_des_L2_dis.npz"

    if not os.path.exists("/home/vectr/Documents/Dataset/test/test_results_botanical_garden/PR.npz"):
